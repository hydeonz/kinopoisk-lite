...
class Database implements DatabaseInterface
{
    ...
    public function getMovieByRating(): array
    {
        $sql = "SELECT movies.*, AVG(reviews.rating) as avg_rating 
                FROM movies 
    ...
    {
        $sql = "SELECT * FROM `movies` WHERE name LIKE '%$name%' OR description LIKE '%$name%'";;
        $stmt = $this->pdo->prepare($sql);
