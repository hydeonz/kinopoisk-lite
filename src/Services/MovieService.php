...
class MovieService
{
    ...
    public function newWithCategories(int $category_id): array
    {
        $movies = $this->db->get('movies', ['category_id'=>$category_id], ['id' => 'DESC'], 10);
        return array_map(function ($movie) {
            return new Movie(
                $movie['id'],
                $movie['name'],
    ...
    public function newWithRating():array
    {
        $movies = $this->db->getMovieByRating();
        return array_map(function ($movie) {
            return new Movie(
                $movie['id'],
                $movie['name'],
    ...
    public function newSearch(string $name):array
    {
        $movies = $this->db->search($name);
        return array_map(function ($movie) {
            return new Movie(
                $movie['id'],
                $movie['name'],
