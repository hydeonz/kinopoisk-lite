    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li>
                    <a href="/  " class="nav-link px-2 text-secondary d-flex align-items-center column-gap-2 link-offset-1-hover">
                ...
                <?php if($auth->check() && $user->is_admin()){?>
                <li>
                ...
                <?php }?>
                <li>
                <form action="/search?name=" method="get" class="nav-link px-2 text-white d-flex align-items-center column-gap-2">
